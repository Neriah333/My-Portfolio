...
const Experience = () => {
  ...
  return (
    <section className="py-20 px-6 bg-slate-900 text-gray-300 font-sans" id="experience">
          ...
          {experiences.map((exp, index) => (
            <div key={index} className="relative pl-8 border-l-2 border-blue-400/30">
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-400 mt-2 md:mt-0 bg-slate-800/50 px-3 py-1 rounded-full border border-slate-700">
                  <Calendar size={14} />
                  {exp.period}
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-blue-400/5 p-6 rounded-xl border border-blue-400/20 animate-float shadow-[0_10px_30px_-15px_rgba(96,165,250,0.3)]">
